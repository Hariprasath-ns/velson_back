...
const NEW_REF_TYPES = ['Quotation_Type'];

const REF_MASTER_DATA = [
  { referenceType: 'Quotation_Type', code: '001', description: 'Commercial', updatedBy: 'ADMIN' },
  { referenceType: 'Quotation_Type', code: '002', description: 'Quotation', updatedBy: 'ADMIN' },
  { referenceType: 'Quotation_Type', code: '003', description: 'Spares', updatedBy: 'ADMIN' },
];

async function seed() {
  console.log('Seeding Quotation_Type...');
