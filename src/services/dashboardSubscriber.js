...
export const handleDashboardEvent = (eventName) => {
  ...
  try {
    const triggerEvents = [
      ...
      SOCKET_EVENTS.JOBCARD_CREATED,
      SOCKET_EVENTS.JOBCARD_STARTED,
      SOCKET_EVENTS.JOBCARD_COMPLETED,
      SOCKET_EVENTS.SERVICE_COMPLETED,
      SOCKET_EVENTS.COMPLAINT_CREATED,
      SOCKET_EVENTS.COMPLAINT_CLOSED,
      SOCKET_EVENTS.MACHINE_BREAKDOWN_CREATED,
      SOCKET_EVENTS.MACHINE_BREAKDOWN_UPDATED,
      SOCKET_EVENTS.DELIVERY_CHALLAN_CREATED
    ];
